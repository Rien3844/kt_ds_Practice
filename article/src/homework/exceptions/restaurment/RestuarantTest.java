...
public class RestuarantTest {
	...
	public static void main(String[] args) {
		...
		vipsMenus[3] = new Menu(false, 1000, 0, 25000, 200); // 식사류
		...
		outbackMenus[2] = new Menu(true, 0, 30, 5000, 15); // 주류
		outbackMenus[3] = new Menu(false, 500, 0, 12000, 200); // 식사류
		...
		try {
			...
			System.out.println(wme.getMessage());// 소지금부족
		}
